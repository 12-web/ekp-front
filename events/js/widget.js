(function () {
    ...
    class EventsApi extends BaseApi {
        ...
        getUserEvents(isInit = true) {
            if (isInit) {
                return mockUserEventsData;
            } else {
                return mockUserEventsData2;
            }
    ...
    class SelectCombobox extends Combobox {
        ...
        setValues(values) {
            ...
            this._values.forEach((user) => {
                ...
                const avatarName = template.querySelector(
    ...
    class UserEventsList {
        ...
        async _getListItems(isInit) {
            const data = await this._api.getUserEvents(isInit);
    ...
    const registrationEventBtnEl = document.querySelector(
