...
// 4) в самом конце скрипта нашел кнопки согласия и отказа через дата-атрибуты. Тут либо добавлять дата-атрибуты в ftl, либо искать через уже заданыне в ftl атрибуты
